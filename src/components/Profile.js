    ...
    return (
        <div className='profile'>
            <div className='profile-content'>
                ...
                <div className='fill'><a target="_blank"  rel="noopener noreferrer" href="https://drive.google.com/file/d/1QC7JbT8fQ5vcielIiKMStfKH6GgX_uXd/view?usp=sharing">Checkout My Resume</a> </div>
            </div>
